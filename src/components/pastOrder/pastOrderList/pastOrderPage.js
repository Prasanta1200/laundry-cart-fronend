...
const PastorderPage = () => {
  ...
  const gettingData = async () => {
    await fetch("https://laundry-backend-ewly.onrender.com/getOrder", {
  ...
  const deleteOrder = async() => {
    ...
    try {
      console.log(orderId);
      await fetch(`https://laundry-backend-ewly.onrender.com/deleteOrder/${orderId}`, {
        method: "DELETE",
        headers: {
          authtoken: token,
        },
  ...
  const changeHandler = (id) => {
    setVisible(!Visible);
    setorderId(id);
    fetch(`https://laundry-backend-ewly.onrender.com/order/${id}`, {
      method: "GET",
      headers: {
        authtoken: token,
      },
